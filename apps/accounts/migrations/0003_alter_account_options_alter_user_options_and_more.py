        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                ...
                default=datetime.datetime(
                    2025, 10, 20, 5, 13, 58, 442953, tzinfo=datetime.timezone.utc
                ),
                verbose_name="생성일시",
            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=20, verbose_name="거래금액"
                    ),
                ),
                (
                    "balance_after",
                    models.DecimalField(
                        decimal_places=2, max_digits=20, verbose_name="거래후잔액"
                    ),
                ),
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=300, verbose_name="거래내용"
                    ),
                ),
                (
                    "transaction_at",
